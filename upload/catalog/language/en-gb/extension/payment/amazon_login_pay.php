...
$_['error_declined_amazon_rejected']               = 'Your payment could not be processed. Please try to place the order again using another payment method.';
$_['error_declined_invalid_payment_method']        = 'Your payment could not be processed, please follow the instructions in the payment method box.';
$_['error_declined_processing_failure']            = 'Your order could not be processed due to a system error. Please try to place the order again.';
$_['error_declined_transaction_timed_out']         = 'Your payment could not be processed. Please try to place the order again using another payment method.';
