...
class ModelExtensionPaymentPayPal extends Model {
	...
	public function hasProductInCart($product_id, $option = array(), $subscription_plan_id = 0) {
	...
	public function editPayPalOrderRecurringNextPayment($subscription_id, $next_payment) {
	...
	public function subscriptionPayment($product_data, $order_data, $paypal_order_data) {
		$_config = new Config();
		$_config->load('paypal');
