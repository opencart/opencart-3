...
class ModelCheckoutOrder extends Model {
    ...
    public function deleteOrder(int $order_id): void {
        ...
        $this->db->query("DELETE FROM `" . DB_PREFIX . "customer_transaction` WHERE `order_id` = '" . (int)$order_id . "'");$this->db->query("DELETE `or`, `ort` FROM `" . DB_PREFIX . "order_recurring` `or`, `" . DB_PREFIX . "order_recurring_transaction` `ort` WHERE `order_id` = '" . (int)$order_id . "' AND `ort`.`order_recurring_id` = `or`.`order_recurring_id`");
