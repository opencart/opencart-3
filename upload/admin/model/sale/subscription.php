...
class ModelSaleSubscription extends Model {
    ...
    public function getSubscriptions(array $data): array {
        ...
        $sort_data = array('s.subscription_id', 's.order_id', 's.reference', 'customer', 's.subscription_status', 's.date_added');
    ...
    public function getTransactions(int $subscription_id): array {
        ...
        foreach ($query->rows as $result) {
            $transaction_data[] = array('date_added' => $result['date_added'], 'description' => $result['description'], 'amount' => $result['amount'], 'order_id' => $result['order_id']);
        }
