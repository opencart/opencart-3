...
class ModelSubscriptionPlan extends Model {
	...
	public function editSubscriptionPlan($subscription_plan_id, $data) {
	...
	public function deleteSubscriptionPlan($subscription_plan_id) {
	...
	public function getDescription($subscription_plan_id) {
