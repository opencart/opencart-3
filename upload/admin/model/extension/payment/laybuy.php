...
class ModelExtensionPaymentLaybuy extends Model {
    public function addRevisedTransaction(array $data = array()): int {
    ...
    public function updateRevisedTransaction(int $id, array $data = array()): void {
