...
class ControllerExtensionPaymentLiqPay extends Controller {
	...
	public function index(): void {
		...
		if (isset($this->request->post['payment_liqpay_order_status_id'])) {
			$data['payment_liqpay_order_status_id'] = (int)$this->request->post['payment_liqpay_order_status_id'];
		} else {
		...
		if (isset($this->request->post['payment_liqpay_geo_zone_id'])) {
			$data['payment_liqpay_geo_zone_id'] = (int)$this->request->post['payment_liqpay_geo_zone_id'];
		} else {
			$data['payment_liqpay_geo_zone_id'] = (int)$this->config->get('payment_liqpay_geo_zone_id');
		}
