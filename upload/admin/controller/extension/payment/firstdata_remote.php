	...
	public function void() {
		...
		if (isset($this->request->post['order_id']) && $this->request->post['order_id'] != '') {
			...
			if (strtoupper($void_response['transaction_result']) == 'APPROVED') {
				...
				$json['msg'] = isset($void_response['error']) && !empty($void_response['error']) ? sprintf($this->language->get('error_status'), (string)$void_response['error']) : $this->language->get('error_void');
			}
		} else {
			$json['error'] = true;
	...
	public function capture() {
		...
		if (isset($this->request->post['order_id']) && $this->request->post['order_id'] != '') {
			...
			if (strtoupper($capture_response['transaction_result']) == 'APPROVED') {
				...
				$json['msg'] = isset($capture_response['error']) && !empty($capture_response['error']) ? sprintf($this->language->get('error_status'), (string)$capture_response['error']) : $this->language->get('error_capture');
	...
	public function refund() {
		...
		if (isset($this->request->post['order_id']) && $this->request->post['order_id'] != '') {
			...
			if (strtoupper($refund_response['transaction_result']) == 'APPROVED') {
				...
				$json['msg'] = isset($refund_response['error']) && !empty($refund_response['error']) ? sprintf($this->language->get('error_status'), (string)$refund_response['error']) : $this->language->get('error_refund');
			}
		} else {
			$json['error'] = true;
