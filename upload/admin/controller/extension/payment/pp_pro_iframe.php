...
class ControllerExtensionPaymentPPProIframe extends Controller {
    ...
    public function index(): void {
        ...
        if (isset($this->request->post['payment_pp_pro_iframe_canceled_reversal_status_id'])) {
            $data['payment_pp_pro_iframe_canceled_reversal_status_id'] = (int)$this->request->post['payment_pp_pro_iframe_canceled_reversal_status_id'];
        } else {
        ...
        if (isset($this->request->post['payment_pp_pro_iframe_completed_status_id'])) {
            $data['payment_pp_pro_iframe_completed_status_id'] = (int)$this->request->post['payment_pp_pro_iframe_completed_status_id'];
        } else {
        ...
        if (isset($this->request->post['payment_pp_pro_iframe_denied_status_id'])) {
            $data['payment_pp_pro_iframe_denied_status_id'] = (int)$this->request->post['payment_pp_pro_iframe_denied_status_id'];
        } else {
        ...
        if (isset($this->request->post['payment_pp_pro_iframe_expired_status_id'])) {
            $data['payment_pp_pro_iframe_expired_status_id'] = (int)$this->request->post['payment_pp_pro_iframe_expired_status_id'];
        } else {
        ...
        if (isset($this->request->post['payment_pp_pro_iframe_failed_status_id'])) {
            $data['payment_pp_pro_iframe_failed_status_id'] = (int)$this->request->post['payment_pp_pro_iframe_failed_status_id'];
        } else {
        ...
        if (isset($this->request->post['payment_pp_pro_iframe_pending_status_id'])) {
            $data['payment_pp_pro_iframe_pending_status_id'] = (int)$this->request->post['payment_pp_pro_iframe_pending_status_id'];
        } else {
        ...
        if (isset($this->request->post['payment_pp_pro_iframe_processed_status_id'])) {
            $data['payment_pp_pro_iframe_processed_status_id'] = (int)$this->request->post['payment_pp_pro_iframe_processed_status_id'];
        } else {
        ...
        if (isset($this->request->post['payment_pp_pro_iframe_reversed_status_id'])) {
            $data['payment_pp_pro_iframe_reversed_status_id'] = (int)$this->request->post['payment_pp_pro_iframe_reversed_status_id'];
        } else {
        ...
        if (isset($this->request->post['payment_pp_pro_iframe_voided_status_id'])) {
            $data['payment_pp_pro_iframe_voided_status_id'] = (int)$this->request->post['payment_pp_pro_iframe_voided_status_id'];
        } else {
        ...
        if (isset($this->request->post['payment_pp_pro_iframe_geo_zone_id'])) {
            $data['payment_pp_pro_iframe_geo_zone_id'] = (int)$this->request->post['payment_pp_pro_iframe_geo_zone_id'];
        } else {
