	...
	public function void() {
		...
		if (isset($this->request->post['order_id']) && $this->request->post['order_id'] != '') {
			...
			if ($void_response['Result'] == 'APPROVED') {
				...
				$json['msg'] = isset($void_response['MESSAGE']) && $void_response['MESSAGE'] != '' ? sprintf($this->language->get('error_status'), (string)$void_response['MESSAGE']) : $this->language->get('error_void');
			}
		} else {
			$json['error'] = true;
