...
class ControllerCatalogProduct extends Controller {
    ...
    protected function getForm() {
        ...
        if (isset($this->request->post['product_subscriptions'])) {
            ...
            $data['product_subscriptions'] = $this->model_catalog_product->getSubscriptionPlans($product_info['product_id']);
        } else {
        ...
        if (isset($this->request->get['product_id'])) {
            $data['product_subscriptions'] = $this->model_catalog_product->getSubscriptionPlans($this->request->get['product_id']);
        } else {
            $data['product_subscriptions'] = [];
        }
    ...
    public function autocomplete(): void {
        ...
        foreach ($results as $result) {
            ...
            $product_subscriptions = $this->model_catalog_product->getSubscriptionPlans($result['product_id']);
