...
if (extension_loaded('mbstring')) {
    function oc_strlen(string $string): string {
        return mb_strlen($string);
    }

    function oc_strpos(string $string, string $needle, int $offset = 0): string {
        return mb_strpos($string, $needle, $offset);
    }

    function oc_strrpos(string $string, string $needle, int $offset = 0): string {
    ...
    function oc_strrpos(string $string, string $needle): string {
    ...
    function oc_to_unicode(string $string): array {
        $unicode = [];
