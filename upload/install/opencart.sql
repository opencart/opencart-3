...
INSERT INTO `oc_event` (`code`, `trigger`, `action`, `status`, `sort_order`) VALUES
('activity_order_add', 'catalog/model/checkout/order/addHistory/before', 'event/activity/addHistory', 1, 0);
INSERT INTO `oc_event` (`code`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
INSERT INTO `oc_event` (`code`, `trigger`, `action`, `status`, `sort_order`) VALUES
('mail_voucher', 'catalog/model/checkout/order/addHistory/after', 'extension/total/voucher/send', 1, 0);
INSERT INTO `oc_event` (`code`, `trigger`, `action`, `status`, `sort_order`) VALUES
('mail_order_add', 'catalog/model/checkout/order/addHistory/before', 'mail/order', 1, 0);
INSERT INTO `oc_event` (`code`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
INSERT INTO `oc_event` (`code`, `trigger`, `action`, `status`, `sort_order`) VALUES
('mail_subscription', 'catalog/model/checkout/subscription/addSubscription/after', 'mail/subscription', 1, 0);
INSERT INTO `oc_event` (`code`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `oc_order_recurring_report`
--

DROP TABLE IF EXISTS `oc_order_recurring_report`;
CREATE TABLE `oc_order_recurring_report` (
  `order_recurring_report_id` int(11) NOT NULL AUTO_INCREMENT,
  `order_recurring_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `ip` varchar(40) NOT NULL,
  `country` varchar(40) NOT NULL,
  `date_added` datetime NOT NULL,
  PRIMARY KEY (`order_recurring_report_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `oc_seo_url` (`seo_url_id`, `store_id`, `language_id`, `query`, `keyword`) VALUES
  (1, 0, 1, 'product_id=48', 'ipod-classic'),
  (2, 0, 1, 'category_id=20', 'desktops'),
  (3, 0, 1, 'category_id=26', 'pc'),
  (4, 0, 1, 'category_id=27', 'mac'),
  (5, 0, 1, 'manufacturer_id=8', 'apple'),
  (6, 0, 1, 'information_id=4', 'about_us'),
  (7, 0, 1, 'product_id=42', 'test'),
  (8, 0, 1, 'category_id=34', 'mp3-players'),
  (9, 0, 1, 'category_id=36', 'test2'),
  (10, 0, 1, 'category_id=18', 'laptop-notebook'),
  (11, 0, 1, 'category_id=46', 'macs'),
  (12, 0, 1, 'category_id=45', 'windows'),
  (13, 0, 1, 'category_id=25', 'component'),
  (14, 0, 1, 'category_id=29', 'mouse'),
  (15, 0, 1, 'category_id=28', 'monitor'),
  (16, 0, 1, 'category_id=35', 'test1'),
  (17, 0, 1, 'category_id=30', 'printer'),
  (18, 0, 1, 'category_id=31', 'scanner'),
  (19, 0, 1, 'category_id=32', 'web-camera'),
  (20, 0, 1, 'category_id=57', 'tablet'),
  (21, 0, 1, 'category_id=17', 'software'),
  (22, 0, 1, 'category_id=24', 'smartphone'),
  (23, 0, 1, 'category_id=33', 'camera'),
  (24, 0, 1, 'category_id=43', 'test11'),
  (25, 0, 1, 'category_id=44', 'test12'),
  (26, 0, 1, 'category_id=47', 'test15'),
  (27, 0, 1, 'category_id=48', 'test16'),
  (28, 0, 1, 'category_id=49', 'test17'),
  (29, 0, 1, 'category_id=50', 'test18'),
  (30, 0, 1, 'category_id=51', 'test19'),
  (31, 0, 1, 'category_id=52', 'test20'),
  (32, 0, 1, 'category_id=58', 'test25'),
  (33, 0, 1, 'category_id=53', 'test21'),
  (34, 0, 1, 'category_id=54', 'test22'),
  (35, 0, 1, 'category_id=55', 'test23'),
  (36, 0, 1, 'category_id=56', 'test24'),
  (37, 0, 1, 'category_id=38', 'test4'),
  (38, 0, 1, 'category_id=37', 'test5'),
  (39, 0, 1, 'category_id=39', 'test6'),
  (40, 0, 1, 'category_id=40', 'test7'),
  (41, 0, 1, 'category_id=41', 'test8'),
  (42, 0, 1, 'category_id=42', 'test9'),
  (43, 0, 1, 'product_id=30', 'canon-eos-5d'),
  (44, 0, 1, 'product_id=47', 'hp-lp3065'),
  (45, 0, 1, 'product_id=28', 'htc-touch-hd'),
  (46, 0, 1, 'product_id=43', 'macbook'),
  (47, 0, 1, 'product_id=44', 'macbook-air'),
  (48, 0, 1, 'product_id=45', 'macbook-pro'),
  (49, 0, 1, 'product_id=31', 'nikon-d300'),
  (50, 0, 1, 'product_id=29', 'palm-treo-pro'),
  (51, 0, 1, 'product_id=35', 'product-8'),
  (52, 0, 1, 'product_id=49', 'samsung-galaxy-tab-10-1'),
  (53, 0, 1, 'product_id=33', 'samsung-syncmaster-941bw'),
  (54, 0, 1, 'product_id=46', 'sony-vaio'),
  (55, 0, 1, 'product_id=41', 'imac'),
  (56, 0, 1, 'product_id=40', 'iphone'),
  (57, 0, 1, 'product_id=36', 'ipod-nano'),
  (58, 0, 1, 'product_id=34', 'ipod-shuffle'),
  (59, 0, 1, 'product_id=32', 'ipod-touch'),
  (60, 0, 1, 'manufacturer_id=9', 'canon'),
  (61, 0, 1, 'manufacturer_id=5', 'htc'),
  (62, 0, 1, 'manufacturer_id=7', 'hewlett-packard'),
  (63, 0, 1, 'manufacturer_id=6', 'palm'),
  (64, 0, 1, 'manufacturer_id=10', 'sony'),
  (65, 0, 1, 'information_id=6', 'delivery'),
  (66, 0, 1, 'information_id=3', 'privacy'),
  (67, 0, 1, 'information_id=5', 'terms');
