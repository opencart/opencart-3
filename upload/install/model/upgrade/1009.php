...
class ModelUpgrade1009 extends Model {
	public function upgrade(): void {
		...
		// Config - FTP
		$this->db->query("DELETE FROM `" . DB_PREFIX . "setting` WHERE `key` = 'config_ftp_status'");
		$this->db->query("DELETE FROM `" . DB_PREFIX . "setting` WHERE `key` = 'config_ftp_root'");
		$this->db->query("DELETE FROM `" . DB_PREFIX . "setting` WHERE `key` = 'config_ftp_password'");
		$this->db->query("DELETE FROM `" . DB_PREFIX . "setting` WHERE `key` = 'config_ftp_username'");
		$this->db->query("DELETE FROM `" . DB_PREFIX . "setting` WHERE `key` = 'config_ftp_port'");
		$this->db->query("DELETE FROM `" . DB_PREFIX . "setting` WHERE `key` = 'config_ftp_hostname'");
